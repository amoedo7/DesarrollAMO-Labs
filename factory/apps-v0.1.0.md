...
4. [x] TemporizAMO — v0.1.0 candidate; CI Android #7 verde con 4 tests + `assembleDebug`; APK exacto recuperado del CI: 11.493 bytes, SHA-256 `0582286941d47f9cea1e4e6c527ac9214e60ad3558b349ac8d3fad93b84e159d`; application_id `com.desarrollamo.temporizamo`, version_code 1; source privado distribuido mediante `StoreAMO-Catalog`/`registry/temporizamo.json` con `direct-artifacts`; `catalog.json` apunta al asset público `temporizamo-v0.1.0/TemporizAMO-0.1.0.apk`; descarga HTTPS anónima real verificada en GitHub Actions contra tamaño, SHA-256 y estructura APK, con evidencia persistida en `verification/temporizamo-v0.1.0.json`; candidate/no Verified y compatible con `Obtener alpha` de StoreAMO. PR fuente #1 fusionado (`73eb9c6a340d18ae6e626edc018399c12824e739`); reparación de distribución StoreAMO-Catalog PR #18 fusionada (`6c3a3af9d75c639eb10197203402f081a7c72e2c`).
