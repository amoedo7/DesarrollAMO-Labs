...
5. [ ] NotasAMO — PRIORIDAD 0 reabierta: v0.1.0 y CI fuente están verdes, pero la auditoría de salud StoreAMO detectó que el source privado sólo declara `distribution.mode=github-release` hacia `amoedo7/NotasAMO` y no existe `registry/notasamo.json` ni artefacto público `direct-artifacts` en StoreAMO-Catalog. APK exacto recuperado del CI: 5.581.509 bytes, SHA-256 `5c195e8c74f37b648a8245bb373fb0562112f93986e0d2afe36eceb3f03b381f`, application_id `com.desarrollamo.notasamo`, version_code 1. No cerrar hasta publicar ese binario en una distribución pública, registrar metadatos sanitizados y verificar descarga HTTPS anónima + SHA real.
6. [ ] TareasAMO
